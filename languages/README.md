...
| Ada | programming | compiled | ci_executed | `gnatmake dejofiqy.adb -o /tmp/hello_ada && /tmp/hello_ada` |
...
| AMPL | programming | interpreted | not_ci_executed | `ampl cowuku.ampl` |
...
| Asymptote | programming | interpreted | not_ci_executed | `asy gofysazu.asy` |
| ATS | programming | interpreted | not_ci_executed | `patscc zokoneca.dats` |
...
| Awk | programming | interpreted | ci_executed | `awk -f lozidojo.awk /dev/null` |
...
| Batchfile | programming | interpreted | not_ci_executed | `cmd ziqa.bat` |
...
| C | programming | compiled | ci_executed | `gcc huby.c -o /tmp/hello_c && /tmp/hello_c` |
| C# | programming | compiled | ci_executed | `cd languages/csharp && dotnet run` |
| C++ | programming | compiled | ci_executed | `g++ webihyru.cpp -o /tmp/hello_cpp && /tmp/hello_cpp` |
| C2hs Haskell | programming | syntax_only | not_ci_executed | `-` |
| C3 | programming | interpreted | not_ci_executed | `c3c xexegexo.c3` |
...
| Ceylon | programming | interpreted | not_ci_executed | `ceylon seqiti.ceylon` |
| Chapel | programming | interpreted | not_ci_executed | `chpl qyti.chpl` |
...
| Clean | programming | interpreted | not_ci_executed | `clm vedu.icl` |
...
| CoffeeScript | programming | interpreted | not_ci_executed | `coffee bajete.coffee` |
| ColdFusion | programming | syntax_only | not_ci_executed | `-` |
| ColdFusion CFC | programming | syntax_only | not_ci_executed | `-` |
| Common Lisp | programming | interpreted | ci_executed | `clisp hubima.lisp` |
...
| Csound | programming | interpreted | not_ci_executed | `csound gavoleli.orc` |
...
| Cython | programming | interpreted | not_ci_executed | `cython wyzybi.pyx` |
| D | programming | compiled | not_ci_executed | `-` |
| Dafny | programming | interpreted | not_ci_executed | `dafny zoja.dfy` |
| Dart | programming | interpreted | not_ci_executed | `dart loxeca.dart` |
...
| Dockerfile | programming | interpreted | not_ci_executed | `docker xeqoge.dockerfile` |
...
| Elixir | programming | interpreted | ci_executed | `elixir hapeka.ex` |
| Elm | programming | transpiled | not_ci_executed | `-` |
| Elvish | programming | interpreted | not_ci_executed | `elvish citycyde.elv` |
| Emacs Lisp | programming | interpreted | not_ci_executed | `emacs --batch defizijy.el` |
| Erlang | programming | interpreted | ci_executed | `escript qeretaro.erl` |
| F* | programming | syntax_only | not_ci_executed | `-` |
| F# | programming | compiled | ci_executed | `cd languages/fsharp && dotnet fsi rarahony.fs` |
| Factor | programming | interpreted | not_ci_executed | `factor dygoruga.factor` |
| Fennel | programming | interpreted | not_ci_executed | `fennel pumoxa.fnl` |
| fish | programming | interpreted | not_ci_executed | `fish finyza.fish` |
| Flix | programming | syntax_only | not_ci_executed | `-` |
| Forth | programming | interpreted | ci_executed | `gforth lavy.fth -e bye` |
| Fortran | programming | compiled | ci_executed | `gfortran syhigupu.f90 -o /tmp/hello_f90 && /tmp/hello_f90` |
| Futhark | programming | interpreted | not_ci_executed | `futhark hamevu.fut` |
| GAML | programming | syntax_only | not_ci_executed | `-` |
| GDScript | programming | interpreted | not_ci_executed | `godot kijaduwi.gd` |
| Gleam | programming | compiled | not_ci_executed | `-` |
| Go | programming | compiled | ci_executed | `go run tiwi.go` |
| Golo | programming | syntax_only | not_ci_executed | `-` |
| Gosu | programming | syntax_only | not_ci_executed | `-` |
| Groovy | programming | interpreted | ci_executed | `groovy wyfaxyhe.groovy` |
| Hack | programming | transpiled | not_ci_executed | `-` |
| Haskell | programming | interpreted | ci_executed | `runghc hydi.hs` |
...
| Hy | programming | interpreted | not_ci_executed | `hy myno.hy` |
| IDL | programming | syntax_only | not_ci_executed | `-` |
| Idris | programming | interpreted | not_ci_executed | `idris wyzyzi.idr` |
| Inform 7 | programming | syntax_only | not_ci_executed | `-` |
| Io | programming | interpreted | not_ci_executed | `io pyki.io` |
| J | programming | interpreted | not_ci_executed | `jconsole gafareba.ijs` |
| Janet | programming | interpreted | not_ci_executed | `janet mihegi.janet` |
| Java | programming | compiled | ci_executed | `java niqupoha.java` |
| JavaScript | programming | interpreted | ci_executed | `node cami.js` |
| JSONiq | programming | syntax_only | not_ci_executed | `-` |
| Julia | programming | interpreted | ci_executed | `julia bowywy.jl` |
...
| LiveScript | programming | interpreted | not_ci_executed | `livescript wipiky.ls` |
...
| Lua | programming | interpreted | ci_executed | `lua5.4 fuhyceha.lua` |
...
| MATLAB | programming | interpreted | not_ci_executed | `octave kalefu.m` |
| Mercury | programming | interpreted | not_ci_executed | `mmc vodi.m` |
...
| NetLogo | programming | interpreted | not_ci_executed | `netlogo pyge.nlogo` |
| NewLisp | programming | interpreted | not_ci_executed | `newlisp cudicuja.nl` |
| Nextflow | programming | interpreted | not_ci_executed | `nextflow dyruzy.nf` |
...
| Objective-C++ | programming | syntax_only | not_ci_executed | `-` |
| OCaml | programming | interpreted | ci_executed | `ocaml kabybuby.ml` |
| Odin | programming | interpreted | not_ci_executed | `odin baby.odin` |
| Opa | programming | transpiled | not_ci_executed | `-` |
| OpenQASM | programming | syntax_only | not_ci_executed | `-` |
| OpenSCAD | programming | interpreted | not_ci_executed | `openscad zikukegi.scad` |
| Oz | programming | syntax_only | not_ci_executed | `-` |
| Pascal | programming | compiled | ci_executed | `fpc gevity.pas -o/tmp/hello_pas >/dev/null && /tmp/hello_pas` |
| Perl | programming | interpreted | ci_executed | `perl paxosaxo.pl` |
| PHP | programming | interpreted | ci_executed | `php mysy.php` |
| Pony | programming | interpreted | not_ci_executed | `pony bymasuba.pony` |
| PowerShell | programming | interpreted | not_ci_executed | `pwsh zogymixe.ps1` |
| Processing | programming | syntax_only | not_ci_executed | `-` |
| Prolog | programming | interpreted | ci_executed | `swipl -q -g "main" -t halt -f zucu.pro` |
| Puppet | programming | interpreted | not_ci_executed | `puppet dezo.pp` |
| PureBasic | programming | syntax_only | not_ci_executed | `-` |
| PureScript | programming | interpreted | not_ci_executed | `purs benugo.purs` |
| Python | programming | interpreted | ci_executed | `python3 cudakece.py` |
| Q# | programming | syntax_only | not_ci_executed | `-` |
| QML | programming | syntax_only | not_ci_executed | `-` |
| R | programming | interpreted | ci_executed | `Rscript bopexywe.R` |
| Racket | programming | interpreted | ci_executed | `racket tutufidu.rkt` |
...
| Red | programming | interpreted | not_ci_executed | `red xedynizu.red` |
| ReScript | programming | transpiled | not_ci_executed | `-` |
| REXX | programming | interpreted | not_ci_executed | `rexx pofyki.rexx` |
| Ring | programming | interpreted | not_ci_executed | `ring piqobefa.ring` |
| RobotFramework | programming | syntax_only | not_ci_executed | `-` |
| Roc | programming | syntax_only | not_ci_executed | `-` |
| Ruby | programming | interpreted | ci_executed | `ruby samibuxi.rb` |
| Rust | programming | compiled | ci_executed | `rustc wymali.rs -o /tmp/hello_rs && /tmp/hello_rs` |
| SAS | programming | interpreted | not_ci_executed | `sas wimame.sas` |
| Scala | programming | compiled | not_ci_executed | `-` |
| Scheme | programming | interpreted | ci_executed | `guile coriqogy.scm` |
| Scilab | programming | interpreted | not_ci_executed | `scilab daqapo.sci` |
| sed | programming | interpreted | ci_executed | `echo foo | sed -f ciwydy.sed` |
| Self | programming | syntax_only | not_ci_executed | `-` |
| Shell | programming | interpreted | ci_executed | `bash fasucami.sh` |
| Slice | programming | syntax_only | not_ci_executed | `-` |
| Smalltalk | programming | interpreted | not_ci_executed | `gst qybode.st` |
| Smarty | programming | transpiled | not_ci_executed | `-` |
| Smithy | programming | syntax_only | not_ci_executed | `-` |
| Snakemake | programming | interpreted | not_ci_executed | `snakemake donape.smk` |
| Solidity | programming | interpreted | not_ci_executed | `solc locisase.sol` |
| SourcePawn | programming | syntax_only | not_ci_executed | `-` |
| SQF | programming | syntax_only | not_ci_executed | `-` |
| SQL | data | interpreted | ci_executed | `sqlite3 :memory: < tygu.sql` |
| Squirrel | programming | interpreted | not_ci_executed | `squirrel wucitoxi.nut` |
| Stan | programming | syntax_only | not_ci_executed | `-` |
| Starlark | programming | syntax_only | not_ci_executed | `-` |
| Stata | programming | interpreted | not_ci_executed | `stata xavewu.do` |
| SuperCollider | programming | syntax_only | not_ci_executed | `-` |
| Swift | programming | compiled | not_ci_executed | `-` |
| SystemVerilog | programming | interpreted | not_ci_executed | `iverilog kodu.sv` |
| Tcl | programming | interpreted | ci_executed | `tclsh syqy.tcl` |
| Terra | programming | interpreted | not_ci_executed | `terra guwijeko.t` |
| Thrift | programming | syntax_only | not_ci_executed | `-` |
| Turing | programming | syntax_only | not_ci_executed | `-` |
| TypeScript | programming | interpreted | ci_executed | `npx --yes tsc jome.ts && node jome.js` |
| UrWeb | programming | syntax_only | not_ci_executed | `-` |
| V | programming | compiled | not_ci_executed | `-` |
| Vala | programming | compiled | ci_executed | `valac bowudafo.vala -o /tmp/hello_vala && /tmp/hello_vala` |
...
| YARA | programming | interpreted | not_ci_executed | `yara jozu.yar` |
| Zeek | programming | interpreted | not_ci_executed | `zeek luku.zeek` |
